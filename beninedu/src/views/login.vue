        ...
        <div class="authentication-inner row m-0">
            ...
            <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5 p-4">
                <div class="w-px-400 mx-auto">
                    ...
                    <!-- /Logo -->
                    <h4 class="mb-2">Bienvenu sur BeninEdu 👋</h4>
                    <p class="mb-4">Connectez vous pour pouvoir acceder a votre espace</p>

                    <form @submit.prevent="getCreditentials" id="formAuthentication" class="mb-3 fv-plugins-bootstrap5 fv-plugins-framework"
